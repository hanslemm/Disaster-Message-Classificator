...
def clean_data(df):
    ...
    predictable_columns = df.iloc[:, 4:].columns
...
def main():
    '''
    Main routine of the process_data.py file. 
    It checks the CLI command looking for 3 arguments:
        1: Actual Messages data filepath
        2: Actual Categories data filepath
        3: Desired database filepath and name 

    Input: none.
    Output: load, clean and save data into sqlite database.
    '''
